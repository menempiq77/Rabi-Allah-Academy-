    ...
    >
      ...
      >
        <button
          ...
          aria-label={t('courseModal.close')}
        >
          <X className="h-5 w-5" />
        </button>
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="font-serif text-2xl font-bold text-slate-900">{content.title}</h2>
            <p className="text-sm font-semibold text-primary-700">{content.price}</p>
          </div>
        </div>
        <p className="mt-6 leading-relaxed text-slate-700">{content.description}</p>
        <div className="mt-6">
          <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-900">
            {t('courseModal.whatLearn')}
          </h3>
        ...
        <div className="mt-6 grid gap-6 sm:grid-cols-2">
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-900">
              {t('courseModal.format')}
            </h3>
            <p className="mt-3 text-slate-600">{content.format}</p>
          </div>
        </div>
