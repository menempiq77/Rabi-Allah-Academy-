...
export default function Articles({ lang = 'en' }) {
  ...
  return (
    <>
      ...
      <div dir={isArabic ? 'rtl' : 'ltr'} className={`font-sans ${isArabic ? 'text-right' : ''}`}>
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-primary-700">
                    ...
                    {content.video && <span className="rounded-full bg-gold-100 px-2 py-1 text-gold-800">{isArabic ? 'فيديو' : 'Watch'}</span>}
                  </div>
