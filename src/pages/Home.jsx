    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            {t('home.welcomeParagraphs').map((paragraph) => (
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              {t('home.tags').map((tag) => (
                <span
                  key={tag}
                  className="rounded-full bg-primary-50 px-4 py-2 text-sm font-medium text-primary-800"
                >
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 rounded-xl bg-gold-500 p-6 text-white shadow-lg">
              ...
              <p className="text-sm font-medium">{t('home.onlineClasses')}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end">
            <div>
              ...
              <h2 className="section-title mt-2">{t('home.programsForEveryStage')}</h2>
              <p className="section-subtitle">{t('home.choosePath')}</p>
            </div>
            <Link to={localePath(lang, '/courses')} className="btn-primary">
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="mt-4 text-xl font-bold text-slate-900">{content.title}</h3>
                    <p className="mt-3 text-slate-600 line-clamp-3">{content.summary}</p>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="section-title mt-2">{t('home.startLearning')}</h2>
            <p className="section-subtitle">{t('home.simpleFlexible')}</p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-sm font-semibold uppercase tracking-wider text-gold-300">
              {t('home.whyStudyWithUs')}
            </p>
            <h2 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl font-serif">
              {t('home.authenticKnowledge')}
            </h2>
          </div>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="section-title mt-2">{t('home.studentsSay')}</h2>
          </div>
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {t('home.testimonialsList').map((testimonial) => (
              <div key={testimonial.name} className="card">
                ...
                <p className="mt-4 leading-relaxed text-slate-700">“{testimonial.text}”</p>
      ...
      <section className="bg-slate-900 py-16 text-center text-white">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <p className="mt-4 text-gold-300">{t('home.quoteAttribution')}</p>
        </div>
      </section>
